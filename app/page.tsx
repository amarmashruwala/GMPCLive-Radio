...
const RESIDENTS: ResidentDJ[] = [
  { id: "1", name: "DJ JACKIE", role: "Resident Host", genre: "SOUL", imageUrl: "https://picsum.photos/seed/jackie/400/520", bio: "Hailing from North London, Jackie curates the premium frequencies of global soul every Monday night. She is known for seamless genre-blending and an impressive collection of rare organic recordings.", mixTitle: "Global Soul Vol. 14", mixUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3" },
  ...
  { id: "3", name: "DJ MARK", role: "Resident Host", genre: "DEEP HOUSE", imageUrl: "https://picsum.photos/seed/mark/400/520", bio: "Mark represents the deep, hypnotic side of warehouse club culture. Mixing standard high-bpm drum patterns with spacey pads, his crates keep the studio locked every Wednesday night.", mixTitle: "Control Room Ambient Set", mixUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3" },
  { id: "4", name: "DJ ROOSTA", role: "Resident Host", genre: "DANCEHALL", imageUrl: "https://picsum.photos/seed/roosta/400/520", bio: "Directing the digital dancehall revolution. Roosta blends Jamaican heritage beats with modern UK basslines to create high-octane sound system sets.", mixTitle: "Dread-Control Selections", mixUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3" },
  ...
  { id: "8", name: "DJ FADA", role: "Afro-Beat Master", genre: "AFROBEATS", imageUrl: "https://picsum.photos/seed/fada/400/520", bio: "Dynamic horn selections, polyrhythmic grooves, and West African rhythms. Fada brings premium, energetic Sunshine-state Afrobeat rhythms to the GMPC airwaves.", mixTitle: "Lagos to London Transit", mixUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3" },
